...
try:
    ...
    st.header(stock_name_full + ' 一か月後を予測しよう(USD) ')
    def stock_predict():
        #機械学習(マシンラーニング)
